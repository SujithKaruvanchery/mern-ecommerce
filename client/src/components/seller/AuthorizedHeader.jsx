...
function AuthorizedHeader() {
  ...
  return (
    <header className="p-2 text-xs font-medium relative">
      <div className="max-w-screen-xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden sm:flex items-center gap-6">
          <Link to="/seller/profile" className="hover:underline uppercase">
            My Account
          </Link>
          <DarkMode />
        </div>
      ...
      {isMenuOpen && (
        <div className="sm:hidden absolute left-0 top-16 w-full p-4 flex flex-col space-y-4 bg-white dark:bg-gray-800 shadow-md">
          ...
          <Link to="/seller/profile" className="block py-2 border-b uppercase">
            My Account
          </Link>
          <DarkMode />
        </div>
