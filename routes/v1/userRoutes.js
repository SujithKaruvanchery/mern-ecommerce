const { registerUser, loginUser, userProfile, logoutUser, checkUser, updateUserProfile, deactivateUser, activateUser, deleteUser, getAllUsers } = require('../../controller/userControllers')
