...
//         const totalProducts = await ProductDB.countDocuments({ seller: sellerId });
//         console.log("Total Products:", totalProducts);

//         const totalOrders = await OrderDB.countDocuments({ seller: sellerId });
//         console.log("Total Orders:", totalOrders);

//         const totalCanceledOrders = await OrderDB.countDocuments({ seller: sellerId, status: "canceled" });
//         console.log("Total Canceled Orders:", totalCanceledOrders);

//         const totalRevenue = await OrderDB.aggregate([
//             { $match: { seller: sellerId, status: { $ne: "canceled" } } }, // Exclude canceled orders from revenue
